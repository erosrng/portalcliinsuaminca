...
var config_default = {
  ...
  update(newValues = {}) {
    ...
    if (theme6) {
      this._theme = __spreadProps(__spreadValues2({}, theme6), {
...
function Carousel_div_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = ɵɵnextContext();
    ɵɵproperty("ngClass", ɵɵpureFunction3(6, _c122, ctx_r1.totalShiftedItems * -1 === ctx_r1.value.length, 0 === index_r5, ctx_r1.clonedItemsForStarting.length - 1 === index_r5));
...
function Carousel_div_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = ɵɵnextContext();
    ɵɵproperty("ngClass", ɵɵpureFunction3(3, _c122, ctx_r1.totalShiftedItems * -1 === ctx_r1.numVisible, 0 === index_r9, ctx_r1.clonedItemsForFinishing.length - 1 === index_r9));
    ɵɵadvance();
...
.p-carousel-indicator-list {
    ...
    justify-content: center;
    flex-wrap: wrap;
    padding: ${dt2("carousel.indicator.list.padding")};
    gap: ${dt2("carousel.indicator.list.gap")};
    margin: 0;
    list-style: none;
}
...
.p-carousel-indicator-button {
    ...
    align-items: center;
    justify-content: center;
    background: ${dt2("carousel.indicator.background")};
    width: ${dt2("carousel.indicator.width")};
    height: ${dt2("carousel.indicator.height")};
    border: 0 none;
    transition: background ${dt2("carousel.transition.duration")}, color ${dt2("carousel.transition.duration")}, outline-color ${dt2("carousel.transition.duration")}, box-shadow ${dt2("carousel.transition.duration")};
    outline-color: transparent;
    border-radius: ${dt2("carousel.indicator.border.radius")};
    padding: 0;
    margin: 0;
    user-select: none;
    cursor: pointer;
...
.p-carousel-indicator-button:focus-visible {
    box-shadow: ${dt2("carousel.indicator.focus.ring.shadow")};
    outline: ${dt2("carousel.indicator.focus.ring.width")} ${dt2("carousel.indicator.focus.ring.style")} ${dt2("carousel.indicator.focus.ring.color")};
    outline-offset: ${dt2("carousel.indicator.focus.ring.offset")};
}

.p-carousel-indicator-button:hover {
    background: ${dt2("carousel.indicator.hover.background")};
}

.p-carousel-indicator-active .p-carousel-indicator-button {
    background: ${dt2("carousel.indicator.active.background")};
}
