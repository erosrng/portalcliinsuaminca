...
export const URLSOLA = 'http://localhost:4200/';
export const PROTEO_URL_ALONE = 'http://localhost:4200/insuaminca/';

export const API_URLINTER = 'http://localhost:4200/insuaminca/api/';
export const URLSOLAINTER = 'http://localhost:4200/';
export const PROTEO_URL_ALONEINTER = 'http://localhost:4200/insuaminca/';  */
